    ...
    while True:
        try:
            ...
            for filename in os.listdir(root_dir):
                if filename.startswith("img_") or filename.startswith("file_v3_") or filename.startswith("codex_log_") or filename.startswith("audio_") or filename.startswith("video_"):
